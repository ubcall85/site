...
let db_placeholder = [
    { id: 4, name: "Ерёмкин Андрей Вячеславович", data: null, category: "students" },
    { id: 1, name: "Крестелёв Анатолий Иванович", data: null, category: "teachers" }
    ];

function get_all_in_category ( cat ){
